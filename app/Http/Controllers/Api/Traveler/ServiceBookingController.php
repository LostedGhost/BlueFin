...
class ServiceBookingController extends Controller
{
    ...
    {
        $service = Service::where('status', 'active')->where('is_published', true)->findOrFail($serviceId);
    ...
    private function attachAndVerifyPayment(ServiceBooking $booking, string $transactionId): void
    {
        ...
        try {
            ...
            \Log::error('Vérification paiement service échouée', ['error' => $e->getMessage()]);
            return;
        }
