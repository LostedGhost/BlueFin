    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-5 py-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          {/* Logo et description */}
          <div>
            <div className="w-12 h-12 bg-[#12b8c9] rounded-xl flex items-center justify-center mb-4">
            ...
            <div key={idx}>
              ...
              <ul className="space-y-2">
                {section.links.map((link, linkIdx) => (
                  <li key={linkIdx}>
                    {link.action ? (
                      <button onClick={link.action} className="text-gray-500 hover:text-[#12b8c9] text-sm transition">
                        {link.label}
                      </button>
                    ) : (
                      <a href={link.url} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#12b8c9] text-sm transition">
                        {link.label}
                      </a>
                    )}
                  </li>
        ...
        {/* Newsletter */}
        <div className="bg-[#eefbfd] rounded-2xl p-6 text-center">
          ...
          <div className="flex max-w-md mx-auto gap-2">
            <input 
              ...
              className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#12b8c9]"
            />
            <button className="bg-[#12b8c9] text-[#0F2940] px-6 py-2 rounded-lg font-semibold hover:bg-[#00b892] transition">
              S'inscrire
            </button>
          </div>
        </div>
